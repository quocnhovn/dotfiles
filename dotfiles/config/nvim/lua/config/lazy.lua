...
require("lazy").setup({
  spec = {
    ...
    -- Database Support
    { import = "plugins.extras.dadbod-ui" },

    -- Enhanced UI and Workflow
    { import = "plugins.extras.edgy" },
    { import = "plugins.extras.copilot-chat-v2-fzf" },
    { import = "plugins.extras.project" },
    { import = "plugins.extras.persisted" },

    -- File Management with Yazi integration
    { import = "plugins.yazi-integration" },

    -- Laravel Support (for PHP projects)
    { import = "plugins.extras.laravel" },

    -- FZF for better search
